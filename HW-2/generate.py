#!env python3
"""
File generator provided with the assignment. Generates `num_files` HTML files
named 0.html .. (num_files-1).html, each containing between 0 and (max_refs-2)
outgoing links (<a HREF="X.html">) to randomly chosen files in [0, num_files).

Links may be duplicated within a file and may point to the file itself.
